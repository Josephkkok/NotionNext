...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一條魚, Hi，我是一條大魚,Hi，我是一條巨鯨,歡迎来到我的飛輪海🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'githubVirtual加密世界2', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'github加密世界', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.facebook.com/profile.php?id=100078104463319', // 网站地址
